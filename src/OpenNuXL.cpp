...
protected:
 ...
 // choose the default value according to the platform where it will be executed
    ...
    registerStringOption_("NuXL:presets", "<option>", "none", "Set precursor and fragment adducts from presets (recommended). Custom presets can be defined in a 'nuxl_presets.json' file placed in the share/openms4/nuxl/ directory or specified via NuXL:presets_file.", false, false);
    registerInputFile_("NuXL:presets_file", "<file>", "", "Optional custom path to nuxl_presets.json file. If not provided, the default file in share/openms4/nuxl/ will be used.", false, true);
